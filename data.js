...
const EVENTS = [
  ...
  { id:8, name:'Drama Society Final Show', category:'cultural', tag:'Cultural', club:'Drama Society', clubId:7,
    ...
    reviews:[] },
  { id:9, name:'UI/UX Design Bootcamp', category:'technical', tag:'Workshop', club:'CS Society', clubId:1,
    date:'Jun 5, 2026', time:'10:00 AM – 4:00 PM', location:'Computing Lab 2',
    desc:'A hands-on workshop on modern UI/UX design principles using Figma. Learn to build user-centric digital products.',
    prize:'', paid:true, price:200, img:IMAGES.events[0], rsvp:false, saved:false,
    reviews:[] },
  { id:10, name:'Summer E-Sports Open', category:'sports', tag:'Sports', club:'Sports Club', clubId:3,
    date:'Jun 20, 2026', time:'12:00 PM – 10:00 PM', location:'Gaming Lounge',
    desc:'The ultimate gaming showdown. Compete in Valorant, FIFA, and Tekken for the title of FAST E-Sports Champion.',
    prize:'Rs 25,000', paid:false, price:0, img:IMAGES.events[2], rsvp:false, saved:false,
    reviews:[] },
  { id:11, name:'Networking & BBQ Night', category:'social', tag:'Social', club:'Entrepreneurship Club', clubId:5,
    date:'Jul 12, 2026', time:'6:00 PM – 10:00 PM', location:'Roof Garden',
    desc:'Connect with alumni and industry professionals over some delicious BBQ. A casual evening of networking and mentorship.',
    prize:'', paid:true, price:600, img:IMAGES.events[1], rsvp:false, saved:false,
    reviews:[] },
  { id:12, name:'Outdoor Movie Night', category:'social', tag:'Social', club:'Music Society', clubId:2,
    date:'Aug 5, 2026', time:'8:00 PM – 11:00 PM', location:'Lawn A',
    desc:'Enjoy a cinematic experience under the stars. Bring your blankets and popcorn for a classic movie screening.',
    prize:'', paid:false, price:0, img:IMAGES.events[5], rsvp:false, saved:false,
    reviews:[] },
  { id:13, name:'Independence Day Gala', category:'cultural', tag:'Cultural', club:'Cultural Society', clubId:4,
    date:'Aug 14, 2026', time:'10:00 AM – 4:00 PM', location:'Main Grounds',
    desc:'Celebrate Independence Day with traditional food stalls, patriotic songs, and a grand flag-hoisting ceremony.',
    prize:'', paid:false, price:0, img:IMAGES.events[4], rsvp:false, saved:false,
    reviews:[] },
];
